    ...
    function insert_into_monitora($IDsensore, $nomeAmbiente, $a){
        ...
        if($result->num_rows>0){
            while($row=$result->fetch_assoc()){
             ...
             //$sql2="INSERT INTO monitora VALUES(,$IDambiente, $IDsensore)";
             //$result2=$mysqli->query($sql2);
            
            
        }
    }
    function selectSetting ($select)
{
       If (select.val() !=0) this.form.submit();
}
    /*
                                        ...
                                        <tr>
                                        	...
                                        	<td><?= $misura ?></td>
                                                <td>
                                                    ...
                                                    <?php $nomeAmbiente=$_POST['ambienti'];
                                                    echo $nomeAmbiente;
                                                    echo insert_into_monitora($ID, $nomeAmbiente, $a++);?>
                                                    </form>
